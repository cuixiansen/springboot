 ...
 * Generated at: 2018-10-26 00:34:57 UTC
...
public final class showadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("   <input type=\"text\" id=\"admin_id\" name=\"admin_id\" hidden>\r\n");
      out.write(" \r\n");
      ...
      out.write("<tr><td>用户名</td></tr>\r\n");
      out.write("<tr><td><input type=\"text\" name=\"adminname\"  id=\"name\" onblur=\"checkName(this,'adminname1')\"/><span id=\"adminname1\"> </span></td></tr>\r\n");
      out.write("<tr><td>密码</td></tr>\r\n");
      out.write("<tr><td><input type=\"text\" name=\"password\"  id=\"password\" onblur=\"checkPassword(this,'beizhu1')\" /><span id=\"beizhu1\" > </span></td></tr>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</table>\r\n");
      ...
      out.write("\turl : 'selectUserByPage',\r\n");
      ...
      out.write("     }, {\r\n");
      out.write("         field: 'admin_name',\r\n");
      out.write("         title: '用户名称'\r\n");
      out.write("     }, {\r\n");
      out.write("         field: 'id',\r\n");
      out.write("         formatter: showrole,\r\n");
      ...
      out.write("\t\t    \t\r\n");
      out.write("\t\t    \t\t\"adminname\":$(\"#acaname\").val(),\r\n");
      out.write("\t\t    \t\t\r\n");
      out.write("\t\t    \t\t\r\n");
      ...
      out.write("\t$(\"#myadmintable\").bootstrapTable({\r\n");
      out.write("\t\t\turl : \"selectAdminByconditionByPage\",\r\n");
      ...
      out.write("\"\r\n");
      out.write("}\r\n");
      out.write("function showrole(value, row ,index){\r\n");
      out.write("\t return  \"<input type='text' value='2' id='\"+value+\"' hidden /> <a calss='btn'  onclick=findrole('\"+value+\"')>显示角色</a>\"\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//显示角色的方法\r\n");
      out.write("function  findrole(id){\r\n");
      out.write("\t//alert($(\"#\"+id+\"\"))\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t     url:\"selectRoleByAdID\",\r\n");
      out.write("\t     type:\"post\",\r\n");
      out.write("\t     data:{\r\n");
      out.write("\t    \t    \"id\":id\t    \t  \r\n");
      out.write("\t     },\r\n");
      ...
      out.write("\t    \t$(\"#\"+id+\"\").parent().html(msg)\r\n");
      out.write("\t    \t//$(\"#\"+id+\"\").parent().html(\"<input style='border: 0px;outline:none;cursor: pointer; background-color:transparent' readonly type='text' value='\"+msg+\"'>\")\r\n");
      out.write("\t   }\r\n");
      out.write(" \t});  \r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t\t\tvar option = \"<input type='checkbox' id=\"+arr[i].roleID+\" name=roleid value='\"+arr[i].roleID+\"'>\"\r\n");
      out.write("\t\t\t\t\t\t+ arr[i].role_name + \":\"+arr[i].role_beizhu+\"<br>\"\r\n");
      out.write("\t\t\t\t$(\"#updatetable\").append($(option))\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfor (var i = 0; i < arr.length; i++) {\r\n");
      out.write("\t\t\t\tvar option = \"<input type='checkbox' id=\"+arr[i].roleID+\" name=roleid1 value='\"+arr[i].roleID+\"'>\"\r\n");
      out.write("\t\t\t\t\t\t+ arr[i].role_name + \":\"+arr[i].role_beizhu+\"<br>\"\r\n");
      ...
      out.write("\t\t$(\"input[name='roleid']\").prop(\"checked\", false);\r\n");
      out.write("\t\t$('#admin_id').val(id);\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl : \"selectRolesById\",\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\tdata : {\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\"id\" : id\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t $(\"input[name='roleid']\") .each(function(i){\r\n");
      out.write("\t\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t\t// alert($(this).val())\r\n");
      out.write("\t\t\t\t\t\t  //alert(i+\"=====\"+obj.value)\r\n");
      out.write("\t\t\t\t\t\t if($(this).val()==a[j].roleID){\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("//判断修改框是否全部选中\r\n");
      out.write("function checkUpdateCbox(){\r\n");
      out.write("\tvar a=\t$(\"input[name='roleid']\").not(\"input:checked\" ).length\r\n");
      out.write("\tvar b= $(\"input[name='roleid']\").length\r\n");
      out.write("\tif(a==b){return true;}\r\n");
      out.write("}\t\r\n");
      out.write("//判断增加框是否全部选中\r\n");
      out.write("function checkInsertCbox(){\r\n");
      out.write("\tvar a=\t$(\"input[name='roleid1']\").not(\"input:checked\" ).length\r\n");
      out.write("\tvar b= $(\"input[name='roleid1']\").length\r\n");
      out.write("\tif(a==b){return true;}\r\n");
      out.write("}\t\t\r\n");
      out.write("\t\r\n");
      out.write("\t//确定修改的方法\r\n");
      out.write("\tfunction submitmodify() {\r\n");
      out.write("\t\tif(checkUpdateCbox()){alert (\"角色至少要选择一个\")}\r\n");
      out.write("\t\telse{\r\n");
      out.write("\t//\talert($(\"input[name='roleid']\").not(\"input:checked\" ).length)\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl : \"updateAdminRole\",\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      ...
      out.write("\t\t\t$(\"#adminname1\").html(\"\")\r\n");
      out.write("\t\t$(\"#beizhu1\").html(\"\")\r\n");
      out.write("\t\t$(\"input[name='roleid1']\").prop(\"checked\", false);\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t//判断空行\r\n");
      out.write("\tfunction isnull() {\r\n");
      out.write("\t\tif (get(\"name\").value.trim() == \"\" || get(\"password\").value.trim() == \"\") {\r\n");
      out.write("\t\t\treturn true\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\treturn false\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("// \t\t\tif (p1 && pn) {\r\n");
      out.write("\t if(checkInsertCbox()){alert(\"至少要选择一个角色\")  }\r\n");
      out.write("\t else{//进行数据的判断\r\n");
      out.write("\t\t    if(p1&&pn){\r\n");
      out.write("\t\t //alert($(\"input[name='roleid1']\").not(\"input:checked\" ).length)\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"insertAdminAndRole\",\r\n");
      out.write("\t\t\t\t\ttype : \"post\",\r\n");
      ...
      out.write("\t\t\t\t\"checkName?adminname=\" + name, true);\r\n");
      ...
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction checkPassword(obj, i) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar p = get(i);\r\n");
      ...
      out.write("\t\t} else {\r\n");
      out.write("\r\n");
      out.write("\t\t\tp.innerHTML = \"<font color='red'> 密码至少是3位，必须由数字字母组成</font>\"\r\n");
      out.write("\t\t\tp1=false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/showadmin.jsp(28,5) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f0.setName("admin:insert");
    int _jspx_eval_shiro_005fhasPermission_005f0 = _jspx_th_shiro_005fhasPermission_005f0.doStartTag();
    if (_jspx_eval_shiro_005fhasPermission_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write(" <li class=\"active\"><a href=\"#\" data-toggle=\"modal\" data-target=\"#myModal1\" onclick=\"deldata()\">新增用户<span class=\"sr-only\"></span></a></li>\r\n");
        out.write("      ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/showadmin.jsp(31,5) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f1.setName("admin:select");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("      \r\n");
        out.write("      <input id=\"acaname\"  name=\"acaname\" type=\"text\" class=\"form-control\" placeholder=\"请输入要搜索的管理员\"/>\r\n");
        out.write("   &nbsp;&nbsp;\r\n");
        out.write("\t\t<input type=\"button\" class=\"btn btn-primary\" value=\"搜索管理员\" onclick=\"searchcate()\" />\r\n");
        out.write("      \r\n");
        out.write("      </div> ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/showadmin.jsp(213,11) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f2.setName("admin:delete");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/showadmin.jsp(214,4) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f3.setName("admin:update");
