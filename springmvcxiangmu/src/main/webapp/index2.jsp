...
<body>
<a href="getCateByExcl" >输出目录信息</a>
<form  id="uplodeform"  action="uplodeCateByExcl"  method="post" enctype="multipart/form-data" >
<input type="file" name="myfile" id="aaa">  <a id="uplode">导入目录信息</a> 
...
$("#uplode").click(function(){
	//console.log($("#uplodeform")[0]);
	$.ajax({  
	     url:"uplodeCateByExcl",
	     type:"post",
	     data:new FormData($("#uplodeform")[0]),
	     processData:false,
	     contentType: false,
	    success:function(msg){
	    	alert(msg);
