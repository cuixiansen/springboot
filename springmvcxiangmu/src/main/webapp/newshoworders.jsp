...
<!--  ======================== dingdan搜索================== -->
      ...
      <li class="active"><a href="#" data-toggle="modal" data-target="#myModal1" onclick="showaddorder()">新增订单<span class="sr-only"></span></a></li>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a   calss='btn' data-toggle='modal' data-target='#myModal3' onclick="ModifyOrderdetail()"">修改订单详情</a>
...
function autoadd(value, row ,index){
	 ...
	 +
	 "&nbsp;&nbsp;&nbsp;&nbsp;<a calss='btn' data-toggle='modal' data-target='#myModal5' onclick=showorderdetail('"+value+"')>订单详情</a>"
