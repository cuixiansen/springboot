...
<body>
 <!--  ======================== 产品搜索================== -->
   <center>   <ul class="nav navbar-nav">
      <li class="active"><shiro:hasRole name="manager"><a href="#" data-toggle="modal" data-target="#myModal1" onclick="deldata()">新增产品<span class="sr-only"></span></a></shiro:hasRole></li>
